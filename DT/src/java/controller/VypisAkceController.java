    ...
    public ModelAndView handleRequest(HttpServletRequest hsr,
        ...
        //parsuje data z url, prevadi native int
          ...
          // podle typu akce vybere nadpisy a vhodny databazovy tabulky
            ...
            switch(druhAkce){
                case 1: nazevTabulky = "JednodenniAkce"; break;
                case 2: nazevTabulky = "VicedenniAkce"; break;
            }
            switch(druhAkce){
                case 1: nadpisSeznamu = "jednodenní akce"; break;
                case 2: nadpisSeznamu = "vicedenní akce"; break;
            }
